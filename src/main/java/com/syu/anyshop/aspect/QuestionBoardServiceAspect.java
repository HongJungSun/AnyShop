...
@Aspect
public class QuestionBoardServiceAspect {

	@Pointcut("execution(* com.syu.anyshop.questionBoard.QuestionBoardService.*(..))")
	private void questionBoardService() {}

	@Around("questionBoardService()")
