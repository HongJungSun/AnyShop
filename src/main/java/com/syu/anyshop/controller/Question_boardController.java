...
public class Question_boardController {
	private static final Logger logger = LoggerFactory.getLogger(Question_boardController.class);
    ...
    public String insertQuestionBoard(@RequestParam String product_id, @RequestParam String title, @RequestParam String contents, 
    									@RequestParam String regi_id) {
    	logger.info("---------------------- 상품문의 글 저장하기 -----------------------------");
    ...
    public String updateBoardCommit(Model model, @RequestParam int idx, @RequestParam String product_id, @RequestParam String title, @RequestParam String contents) {
    	logger.info("---------------------- 상품문의 글 수정 완료-----------------------------");
    ...
    public String deleteBoard(Model model, Paging paging, @RequestParam String keyword, @RequestParam String searchBoard, @RequestParam String product_id) {
    	logger.info("---------------------- 상품문의 글  검색 컨트롤러 -----------------------------");
    ...
    public String deleteReplyBoard(Model model, @RequestParam int reply_no, @RequestParam int reparent, @RequestParam int board_no, @RequestParam int reparent2, 
    								@RequestParam int redepth, @RequestParam int idx, @RequestParam int reorder) {
    	logger.info("---------------------- 상품문의 댓글  글 삭제 컨트롤러-----------------------------");
